...
export default function AboutSection() {
  return (
    <section id="about" className={`py-20 w-full bg-white dark:bg-black dark:text-white ${FontArista.className}`}>
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between">
        <div className="md:w-1/2 mb-10 md:mb-0 flex flex-col items-center md:items-start">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-800 dark:text-white text-center md:text-left">
          ...
          <p className="text-xl mb-6 text-gray-600 dark:text-gray-300 text-center md:text-left">
            ...
            Com uma equipe altamente qualificada e comprometida, atuamos em diversos setores, oferecendo serviços personalizados para atender às necessidades de nossos clientes.
          </p>
        </div>
