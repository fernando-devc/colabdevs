...
export default function CasesSection() {
  return (
    <section id="cases" className={`py-16 bg-gray-100 dark:bg-black dark:text-white w-full ${FontArista.className}`}>
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800 dark:text-white mb-12 md:mb-16">Cases de Sucesso</h2>
...
function CaseCard({ title, description, tech, imageUrl, link }: CaseCardProps) {
  return (
    <a href={link} target="_blank" rel="noopener noreferrer">
      <div className="bg-white dark:bg-gray-800 dark:text-white p-6 md:p-8 rounded-lg shadow-lg flex flex-col md:flex-row transition-transform hover:scale-105 cursor-pointer">
        <div className="flex-grow mb-4 md:mb-0">
          <h3 className={`text-xl md:text-2xl font-semibold text-gray-800 dark:text-white mb-2 md:mb-4 font-arista`}>{title}</h3>
